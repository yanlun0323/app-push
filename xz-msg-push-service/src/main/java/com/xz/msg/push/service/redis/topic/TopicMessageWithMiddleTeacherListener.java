 ...
 *
 */
@Service("topicMessageWithMiddleTeacherListener")
public class TopicMessageWithMiddleTeacherListener extends AbstractTopicMessageListener {

	private static final Log logger = LogFactory.getLog(TopicMessageWithMiddleTeacherListener.class);
	...
	public String getQueueKey() {
		return RedisKeyConfigure.MIDDLE_TEACHER_TOPIC_KEY;
	}
