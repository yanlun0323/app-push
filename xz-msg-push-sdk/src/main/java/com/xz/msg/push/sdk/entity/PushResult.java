...
public class PushResult {
    ...
    public PushResult(int resultCode, String message) {
        this.resultCode = resultCode;
        this.message = message;
    }

    public PushResult(int resultCode, String message, Throwable exception) {
        this.resultCode = resultCode;
        this.message = message;
    ...
    public static void setDefaultSuccess(int defaultSuccess) {
        PushResult.DEFAULT_SUCCESS = defaultSuccess;
    }
    ...
    public static PushResult success(String message) {
        return new PushResult(DEFAULT_SUCCESS, message);
    }
    ...
    public static PushResult fail(int resultCode, String message) {
        return fail(resultCode, message, null);
    }

    public static PushResult fail(int resultCode, String message, Throwable exception) {
        if (resultCode == DEFAULT_SUCCESS) {
            throw new IllegalArgumentException("失败的代码不能与 DEFAULT_SUCCESS 相同");
        }
        return new PushResult(resultCode, message, exception);
    }
     ...
     * @return Result 对象自身
     */
    public PushResult set(String key, Object value) {
        if (this.data == null) {
